...
This Automation problems mainly occur when the service to be tested is not under the tester control, otherwise, captcha and other popup could be easily deactivated for testing purposes. This means that this problem is happening only on specific use case scenarios, and so, it is not a big deal.
